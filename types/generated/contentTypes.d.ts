...
export interface ApiBangGiaBangGia extends Schema.SingleType {
  collectionName: 'bang_gias';
  info: {
    singularName: 'bang-gia';
    pluralName: 'bang-gias';
  ...
  attributes: {
    ...
    priceData: Attribute.Component<'share.price', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::bang-gia.bang-gia',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiDichVuDichVu extends Schema.SingleType {
  ...
  attributes: {
    ...
    image: Attribute.Component<'share.image'>;
    imageServices: Attribute.Component<'share.box-content', true> &
      Attribute.SetMinMax<
        {
          max: 4;
        },
        number
      >;
    banner: Attribute.Component<'share.image'>;
...
export interface ApiFooterFooter extends Schema.SingleType {
  ...
  attributes: {
    logoWhite: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    time: Attribute.String;
    address: Attribute.String;
    phone: Attribute.String;
    titleFooter: Attribute.String;
    contentFooter: Attribute.RichText &
...
export interface ApiHotLineHotLine extends Schema.SingleType {
  collectionName: 'hot_lines';
  info: {
    singularName: 'hot-line';
    pluralName: 'hot-lines';
    displayName: 'HotLine';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiKhachHangKhachHang extends Schema.CollectionType {
...
export interface ApiTinTucPageTinTucPage extends Schema.SingleType {
  collectionName: 'tin_tuc_pages';
  info: {
    singularName: 'tin-tuc-page';
    pluralName: 'tin-tuc-pages';
    displayName: 'Tin T\u1EE9c Page';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiTrangChuTrangChu extends Schema.SingleType {
  ...
  attributes: {
    seo: Attribute.Component<'share.seo'>;
    banner: Attribute.Component<'share.image', true>;
    about: Attribute.Component<'home.about'>;
    slide: Attribute.Component<'share.box-content', true>;
    titleSection: Attribute.String;
    contentServices: Attribute.Component<'share.box-content', true>;
    doctor: Attribute.Component<'home.doctors'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::bang-gia.bang-gia': ApiBangGiaBangGia;
      'api::dich-vu.dich-vu': ApiDichVuDichVu;
      'api::footer.footer': ApiFooterFooter;
      'api::hot-line.hot-line': ApiHotLineHotLine;
      ...
      'api::tin-tuc-page.tin-tuc-page': ApiTinTucPageTinTucPage;
